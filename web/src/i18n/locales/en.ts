...
const en: Translation = {
	...
	backup: {
		...
		exportHint:
			"Export all providers, models, virtual models, API keys and settings as a JSON file (contains plaintext secrets — keep it safe).",
		exportFailed: "Export failed",
		importHint: "Drop the backup JSON file here, or pick a file below.",
		dropzoneLabel: "Drag and drop a file here",
		chooseFile: "Choose file",
		selectedFile: "Selected:",
		noFile: "No file selected",
		confirmImport: "Import",
		confirmImportTitle: "Confirm restore",
		confirmImportBody:
			"This will clear and replace all providers, virtual models and API keys, and overwrite system settings (settings not in the backup are kept). This cannot be undone, and the backup contains plaintext secrets — only proceed if you trust the source.",
		confirmCancel: "Cancel",
		confirmOk: "Import",
		importSuccess: "Imported successfully",
		errorDialogTitle: "Restore failed",
		errorDialogBody: "The backup file could not be imported. Check the file content.",
	},
	overview: {
