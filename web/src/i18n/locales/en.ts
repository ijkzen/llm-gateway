...
// 英文文案。以 `: Translation` 标注（形状取自 zh-CN.ts）保证与中文源 key 完全对齐
// ——缺键/多键都会在编译期报错。
const en: Translation = {
	...
	providers: {
		...
		proxyAddrAuthUnsupported: "Proxy address with authentication is not supported yet",
		proxyOn: "On",
		proxyOff: "Off",
	...
	virtualModels: {
		...
		staleDraftMembers:
			"{{count}} member model(s) are no longer in the provider model list; remove them and retry",
	},
	...
	settings: {
		...
		value: "Value",
		type: "Type",
		jsonEmptyEntry: "Array entries cannot be empty; fill or remove the row",
		jsonEmptyKey: "Keys cannot be empty; fill or remove the row",
		jsonDuplicateKey: 'Duplicate key "{{key}}"; rename or remove it',
		builtinNotDeletable: "Built-in setting; cannot be deleted",
		updatedAt: "Updated",
		edit: "Edit",
